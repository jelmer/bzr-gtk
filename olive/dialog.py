...
class OliveDialog:
    ...
    def error_dialog(self, primary, secondary):
        """ Display an error dialog with the given message. """
        self._message_dialog('error', primary, secondary)
    
    def info_dialog(self, primary, secondary):
        """ Display an info dialog with the given message. """
        self._message_dialog('info', primary, secondary)
    
    def warning_dialog(self, primary, secondary):
        """ Display a warning dialog with the given message. """
        self._message_dialog('warning', primary, secondary)
